modded class Winchester70_Base
{
	override void ND_InitTextures()
	{
		...
		ND_RegisterTextureAndMaterial("Drifter", "Weapon Reskin Mod Example\\data\\Firearms\\Winchester\\Drifter\\winchester70_Drifter_co.paa","Weapon Reskin Mod Example\\data\\Firearms\\Winchester\\Drifter\\winchester70_Drifter.rvmat");
